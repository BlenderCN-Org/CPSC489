...
inline void AABB_load_unit(AABB_halfdim& b)
{
 b.center[0] = 0.0f;
 b.center[1] = 0.0f;
 b.center[2] = 0.0f;
...
inline void AABB_translate(AABB_halfdim& b, const float* v)
{
 b.center[0] += v[0];
 b.center[1] += v[1];
 b.center[2] += v[2];
...
inline void OBB_load_unit(OBB& b)
{
 b.center[0] = 0.0f;
 b.center[1] = 0.0f;
 b.center[2] = 0.0f;
...
inline void OBB_translate(OBB& b, const float* v)
{
 b.center[0] += v[0];
 b.center[1] += v[1];
 b.center[2] += v[2];
